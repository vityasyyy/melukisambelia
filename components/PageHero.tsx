...
export function PageHero({
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 z-[1] w-[30vw] max-w-[350px]">
        <Image
      ...
      <div aria-hidden className="pointer-events-none absolute left-[4vw] top-[18%] z-[1] w-[14vw] max-w-[160px]">
        <Image
      ...
      <div aria-hidden className="pointer-events-none absolute right-[6vw] bottom-[15%] z-[1] w-[11vw] max-w-[130px]">
        <Image
          src="/images/design-system/bunga_sambel.svg"
          alt=""
          width={160}
