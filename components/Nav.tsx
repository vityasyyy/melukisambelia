...
export function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-tan-700/10 bg-page/90 backdrop-blur">
      <nav className="mx-auto flex max-w-content items-center justify-between px-4 py-3">
        ...
        <button
          className="-mr-2 p-2 text-ink hover:text-water-900 md:hidden"
      ...
      {open && (
        <div className="border-t border-tan-700/10 bg-page md:hidden">
