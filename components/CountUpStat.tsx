...
export function CountUpStat({ label, value }: { label: string; value: string }) {
  ...
  if (!hasDigits(value)) {
    return (
      <div className="glass-card glass-accent-top group relative h-full flex flex-col items-center justify-center min-w-0 p-5 sm:p-6 text-center" style={{ '--accent-color': '#F0AC6D' } as React.CSSProperties}>
