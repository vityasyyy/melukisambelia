...
const POSITION_CLASSES: Record<Position, string> = {
  'top-left': 'top-2 left-2 sm:left-6',
  'top-right': 'top-2 right-2 sm:right-6',
  'bottom-left': 'bottom-2 left-2 sm:left-6',
  'bottom-right': 'bottom-2 right-2 sm:right-6',
  'center-left': 'top-1/2 -translate-y-1/2 left-2 sm:left-6',
  'center-right': 'top-1/2 -translate-y-1/2 right-2 sm:right-6',
}

const SIZE_CLASSES: Record<Size, string> = {
  sm: 'w-32 h-32 sm:w-40 sm:h-40 lg:w-44 lg:h-44',
  md: 'w-40 h-40 sm:w-48 sm:h-48 lg:w-52 lg:h-52',
