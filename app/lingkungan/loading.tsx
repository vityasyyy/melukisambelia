...
export default function LingkunganLoading() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-green-900 via-olive to-brown-900 py-12 md:py-20 text-center text-cream-light">
