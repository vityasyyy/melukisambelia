...
export function AirTanahClient({
  ...
  return (
    <div className="mx-auto max-w-content px-4 py-16">
      <SectionHeader
        kicker="AIR & TANAH"
        title="Tinggi Muka Airtanah"
        intro="Data Tinggi Muka Airtanah (TMA) dan Daya Hantar Listrik (DHL) dari survei lapangan di Kecamatan Sambelia."
        tone="water"
      />
        ...
        <>
          ...
          <FadeIn delay={0.2}>
            <div className="mt-8 rounded-2xl border border-tan-700/20 bg-cream-beige/40 p-4 shadow-terracotta">
              <h3 className="mb-4 font-beautique text-lg text-brown-900">Grafik TMA per Lokasi</h3>
      ...
      {credit && (
        <p className="mt-8 text-center text-xs text-ink/40">{credit}</p>
      )}
