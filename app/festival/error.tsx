...
export default function FestivalError(props: { error: Error & { digest?: string }; reset: () => void }) {
  void props.error
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-20 text-center">
      ...
      <p className="mt-2 text-ink/70">Maaf, terjadi kesalahan saat memuat halaman festival.</p>
      <div className="mt-6 flex gap-3">
        <button
          onClick={props.reset}
          className="rounded-full bg-gold-700 px-6 py-3 font-medium text-page transition-colors hover:bg-gold-500"
        >
          Coba Lagi
        </button>
        <Link
