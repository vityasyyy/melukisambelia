...
export default function CeritaError(props: { error: Error & { digest?: string }; reset: () => void }) {
  void props.error
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-20 text-center">
      ...
      <p className="mt-2 text-ink/70">Maaf, terjadi kesalahan saat memuat halaman cerita.</p>
